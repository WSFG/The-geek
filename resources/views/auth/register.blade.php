            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" >
                        ...
                        <div class="form-group row">
                            <label for="user_main_photo" class="col-md-4 col-form-label text-md-right">{{ __('User photo') }}</label>

                            <div class="col-md-6">
                                <input id="user_main_photo" type="file" accept="image/*" class="form-control{{ $errors->has('user_main_photo') ? ' is-invalid' : '' }}" name="user_main_photo" value="{{ old('user_main_photo') }}" required >
